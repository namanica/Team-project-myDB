...
DROP TABLE IF EXISTS `databaseLab5`.`SingleChoiсe` ;
CREATE TABLE IF NOT EXISTS `databaseLab5`.`SingleChoiсe` (
  `id` INT NOT NULL,
  `variant` VARCHAR(45) NULL,
  `Content_id` INT NOT NULL,
  PRIMARY KEY (`id`, `Content_id`),
  INDEX `fk_SingleChoiсe_Content1_idx` (`Content_id` ASC) VISIBLE,
  CONSTRAINT `fk_SingleChoiсe_Content1`
    FOREIGN KEY (`Content_id`)
    REFERENCES `databaseLab5`.`Content` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
DROP TABLE IF EXISTS `databaseLab5`.`MultiChoiсe` ;
CREATE TABLE IF NOT EXISTS `databaseLab5`.`MultiChoiсe` (
  `id` INT NOT NULL,
  `variants` JSON NULL,
  `Content_id` INT NOT NULL,
  PRIMARY KEY (`id`, `Content_id`),
  INDEX `fk_MultiChoiсe_Content1_idx` (`Content_id` ASC) VISIBLE,
  CONSTRAINT `fk_MultiChoiсe_Content1`
    FOREIGN KEY (`Content_id`)
    REFERENCES `databaseLab5`.`Content` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
START TRANSACTION;
USE `databaseLab5`;
INSERT INTO `databaseLab5`.`SingleChoiсe` (`id`, `variant`, `Content_id`) VALUES (1, 'a', 1);
INSERT INTO `databaseLab5`.`SingleChoiсe` (`id`, `variant`, `Content_id`) VALUES (2, 'sadness', 1);
INSERT INTO `databaseLab5`.`SingleChoiсe` (`id`, `variant`, `Content_id`) VALUES (3, 'Deer', 1);
COMMIT;

START TRANSACTION;
USE `databaseLab5`;
INSERT INTO `databaseLab5`.`MultiChoiсe` (`id`, `variants`, `Content_id`) VALUES (1, '{\"1\":\"a\",\"2\":\"b\",\"3\":\"c\"}', 1);
INSERT INTO `databaseLab5`.`MultiChoiсe` (`id`, `variants`, `Content_id`) VALUES (2, '{\"1\":\"d\",\"2\":\"b\",\"3\":\"c\"}', 1);
COMMIT;
